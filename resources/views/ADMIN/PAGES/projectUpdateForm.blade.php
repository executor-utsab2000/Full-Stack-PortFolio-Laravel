                ...
                <div class="col-md-3 px-2 my-2">
                    <div class="inputContainers">
                        <div class="coolinput">
                            ...
                            <input type="text" placeholder="Write here..." name="monthsUsed" class="input"  value="{{ json_decode($projectData->project_duration)->month }}">
                            @error('monthsUsed')
                                <span class="errorMsg text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                ...
                <div class="col-md-3 px-2 my-2">
                    <div class="inputContainers">
                        <div class="coolinput">
                            ...
                            <input type="text" placeholder="Write here..." name="daysUsed" class="input" value="{{ json_decode($projectData->project_duration)->day }}">
                            @error('daysUsed')
                                <span class="errorMsg text-danger">{{ $message }}</span>
                            @enderror
                        </div>
